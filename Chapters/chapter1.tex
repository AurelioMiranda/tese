...
There is always a need for innovation, and consequently, technological progress is accompanied by an increase in system complexity~\cite{lee2008}, either software or hardware. This complexity is accompanied by enormous challenges in creating the solutions, particularly when software and hardware are adjacent to one another, such as is the situation when working with the robotics programming field. 
