...
\begin{xltabular}{\textwidth}{Xccccc}
	...
	\label{tab:hla:results1}\\
	\toprule
	\rowcolor{Gainsboro}%
	Feature   & Simulink  & OpenModelica  & Temp   & Temp            & RAMSES \\
	\midrule
	Identifiers\footnote{Names of Functions, Classes, Variables, etc}     & Yes       & No          & 1          & 1              & No \\
	Optimization~\cite{Artho03}   & 1        & 4          & 1          & \emph{2B, 1C}          & 0 \\
	Legacy Code Integration    & 1        & 2          & 1          & \emph{A}              & 0 \\
