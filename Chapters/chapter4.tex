...
This feature was fairly easy to integrate as there are already workflow options that offer similar capabilities. More technical details can be found in Section~\ref{sec:workflows_script_executor}.
