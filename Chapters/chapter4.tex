...
Beyond that, the meeting also served as a sneak peak to what the final \gls{RAMSES} product would look like, including every gymmic, option, page and also a code generation dedicated section that ties perfectly with the current work.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{beforeLanguageChange.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{afterLanguageChange.png}
