...
\begin{xltabular}{\textwidth}{X X X X X}
	...
	\midrule
	P1 & 1 year & None & None & Primary background in model-driven engineering. \\
	P2 & 1 year & Light (Academic) & Brief (Early version) & Accompanied the concept of the \gls{DSL} during development. \\
