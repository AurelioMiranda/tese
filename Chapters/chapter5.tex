...
Figure~\ref{fig:eclipse_config_business} highlights the business logic menu options. These options do influence a lot of the generation process but they do not restrict any other configuration option.
