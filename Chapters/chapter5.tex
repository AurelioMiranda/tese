...
\begin{xltabular}{\textwidth}{X X X}
	...
	Dead Code\par Detection & Traceability, Report & Needs stable generation logic \\
...
The logic of the traceability is quite complex, however, its configuration options are pretty simple: either enabled or disabled.
