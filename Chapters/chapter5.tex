...
\begin{table}[htbp]
	...
	\begin{tabular}{p{3cm} p{10cm}}
		...
		P3 & Although participant 3 was not familiarized with the Eclipse environment he adapted very quickly and understood the task perfectly, proving that the system is intuitive even to newcomers. \\
		P4 &  \\
		P5 &  \\
		\bottomrule
	\end{tabular}
