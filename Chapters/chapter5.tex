...
The information on Table~\ref{tab:usability_tasks} is averaged between all test users on completion time and summed on help requests. The task completion times per individual user can be found on Table~\ref{tab:ttpt}.
