...
% TODO: Add explicit Research Questions (RQ1, RQ2, ...).
% TODO: Add operational definition of usability criteria (ISO 9241-11 or equivalent).

With the \gls{DSL} finalized and its features implemented it is then possible to assess how an end user will interact with the newly developed features. The object of study is the developed \gls{DSL} and configuration workflow it uses. The main purpose of this usability validation test is to evaluate, understand, and improve the code configuration \gls{DSL} and workflow.
...
For these tests the participants will be mostly end users with moderate \gls{AADL} knowledge and a highly experienced \gls{ROS} developer\footnote{7+ years of commercial \gls{ROS} usage.} that directly represents the target demographic.
...
% TODO: Add sampling justification and population definition.
% TODO: State clearly that the participants are a convenience sample (Falessi ST7/ST8).
% TODO: Describe expected user population in RAMSES/ROS context and how this sample represents it.
...
% TODO: Explicitly connect usability requirements to measurable dependent variables.
...
% TODO: Replace TODO above with the precise number of participants.
% TODO: Add participant characterization (experience levels, years working with AADL, exposure to DSLs, exposure to ROS).
% TODO: Identify which participants interacted with the DSL during development.
% TODO: Add inclusion/exclusion criteria.
% TODO: Add recruitment method.
% TODO: Add whether participants were blinded to study goals.


\subsection{Experimental Materials}
\label{sec:test_usabl_materials}

% New section required by Jedlitschka

% TODO: Specify RAMSES version, DSL editor version, OS, hardware environment.
% TODO: Describe all test artefacts: example AADL model, configuration project, ROS-related libraries, etc.
% TODO: Provide screenshots or references to appendices where appropriate.


\subsection{Tasks}
\label{sec:test_usabl_tasks}

% TODO: Add rationale for task selection and coverage.
% TODO: State whether task order was fixed or counterbalanced.
% TODO: Note risk of learning effects if fixed order used.
% TODO: Indicate difficulty levels of tasks (simple/advanced).
...
% TODO: Connect criteria to previously defined usability goals.
