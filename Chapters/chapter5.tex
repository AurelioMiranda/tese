...
\begin{itemize} 
	\item The ability to change identifier (class, variable, method) formats dynamically from a list of implemented options (TODO: list all options).
	\item Based on the selected language, assign different styles to different identifiers (TODO: example in C++).
