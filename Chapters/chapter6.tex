...
The usability validation (Section~\ref{sec:test_val}) addressed the concern that introducing a \gls{DSL} might add cognitive complexity to the workflow. The \gls{SUS} scores, averaging 76.5, suggest that the system falls within the "Good" range of usability.
...
The conceptualization, implementation and evaluation of this \gls{DSL} provided many opportunities to learn and grow as a software engineer. Many of which derived from necessities inside the \gls{DSL} development itself. 
