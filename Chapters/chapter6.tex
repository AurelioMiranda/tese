...
The testing environment remained mostly the same with the exception of the switch from Ubuntu for windows to a virtual machine with linux along with the \gls{RAMSES} version changing to Oct 27, 2025 (commit 3eb5118b57903cc5077ad4218fc83e182cbab199).
...
The goal was not only to acquire real data in a real environment but also to highlight any flaws or issues that might have been overlooked in the development phase.

TODO: this section will be finished in the future
