...
\epigraph{ \textit{This chapter summarizes the final outcomes of the research and outlines potential avenues for future development.}}
...
\begin{itemize} 
	\item \textbf{Additional Languages: } Support for C, Assembly, Kotlin, Ada or Rust, which are increasingly relevant in safety-critical domains. This would require extending the 'Language' Ecore class and implementing new Acceleo templates that respect the specific memory safety models of Rust or the strict typing of Ada.
